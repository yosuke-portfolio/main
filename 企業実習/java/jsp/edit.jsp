    ...
    <div class="main">
        ...
        <form name="form1" action="CustomerServlet" method="post" onsubmit="return funcConfirm()">
            <table>
                <tr>
                     <td>氏名</td>
                     <td><input type="text" name="name" value="<%= customer.getName() %>" maxlength="20" /></td>
                </tr>
                <tr>
                     <td>郵便番号</td>
                ...
                <tr>
                     <td>住所2</td>
                     <td><input type="text" name="address2" value="<%= customer.getAddress2() %>" maxlength="100"/></td>
                </tr>
                <tr>
                     <td>TEL</td>
                     <td><input type="text" name="tel" value="<%= customer.getTel() %>" maxlength="20" /></td>
                </tr>
                <tr>
                     <td>FAX</td>
                ...
                <tr>
                     <td>E-mail</td>
                     <td><input type="text" name="email" value="<%= customer.getEmail() %>" maxlength="100" /></td>
                </tr>
            </table>
            <p>
